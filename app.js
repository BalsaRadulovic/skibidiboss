...
function provjeriFormu() {
  ...
  /*if (ime.value.match(usernamePattern) && email.value.match(emailPattern) && lozinka.value.match(passPattern)) {
        alert('dobro je')
    } else {
        alert('nije dobro')
    }*/
...
registracijaDugme.addEventListener("click", (e) => {
  ...
  if (daLiJeFormIspravna()) {
    registracijaDugme.style.background = "green";
  } else {
    registracijaDugme.style.background = "rgb(255, 91, 91)";
  }
});
